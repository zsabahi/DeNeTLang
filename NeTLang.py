...
from neTLang_FastTest_Kfold import neTLangFastTestKFold
...
#            continue
        ...
        if processing == Processing.fasttest.name:
            neTLangFastTest(classifierTask, frameworknetconfigs, k_windows, excelfile, date)
        
        elif processing == Processing.fasttestkfold.name:
            neTLangFastTestKFold(classifierTask, frameworknetconfigs, k_windows, excelfile, date)
        
        elif processing == Processing.kfold.name:
